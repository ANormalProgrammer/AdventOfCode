...
long long part2(std::vector<std::string> input)
{
    ...
    for( auto &game : input)
    {
        ...
        long long max_red = std::numeric_limits<long long int>::min();
        long long max_blue = std::numeric_limits<long long int>::min();
        long long max_green = std::numeric_limits<long long int>::min();
